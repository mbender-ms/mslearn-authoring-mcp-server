...
Here's what it takes to upgrade to Windows 10 on your PC or tablet: 
  ...
  - **Latest OS**: Make sure you're running the latest version—either Windows 7 SP1 or Windows 8.1 Update.
      ...
      - [Find out which version you're running ](https://windows.microsoft.com/windows/which-operating-system)
    
      - Need the latest version? Download [Windows 7 SP1](https://windows.microsoft.com/windows7/install-windows-7-service-pack-1) or [Windows 8.1 Update.](https://windows.microsoft.com/windows-8/update-from-windows-8-tutorial)

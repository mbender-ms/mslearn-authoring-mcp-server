...
## Negative numbers
  ...
  Form a negative number with a minus sign, not an en dash:<br />
  **Example**  
  &minus;79
...
[Bits and bytes term collection](/style-guide/a-z-word-list-term-collections/term-collections/bits-bytes-terms)  
[Em dashes, en dashes, hyphens, and minus signs](/style-guide/punctuation/dashes-hyphens/index)  
[Percent, percentage](/style-guide/a-z-word-list-term-collections/p/percent-percentage)  
